...
int main(int argc, char *argv[])
{
	...
	Node l8 = Node(8,nullptr,nullptr);
		Node lv3_4 = Node(-4,&l7,&l8);
				Node lv2_2 = Node(-2,&lv3_3,&lv3_4);
					Node lv1_1 = Node(-1,&lv2_1,&lv2_2);
	...
	Node l16 = Node(10,nullptr,nullptr);
		Node lv3_8 = Node(-8,&l15,&l16);
				Node lv2_4 = Node(-4,&lv3_7,&lv3_8);
					Node lv1_2 = Node(-2,&lv2_3,&lv2_4);
						Node lv0_1 = Node(-1,&lv1_1,&lv1_2);
